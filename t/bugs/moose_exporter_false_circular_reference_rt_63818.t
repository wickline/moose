...
# OKSet1
{
    ...
    use Moose ();
    Moose::Exporter->setup_import_methods( also => [qw(
        Moose
    )]);
}
...
# NotOKSet1
{
    ...
    use Moose ();
    ::like(
        ::exception{ Moose::Exporter->setup_import_methods( also => [qw(
            Moose
...
# Alas, I've not figured out how to craft a test which shows that
# we get the same error for mult-hop circularity... instead I get
# tests that die because one of the circularly-referenced things
# was not loaded.
